...
obraz_median = obraz.filter(ImageFilter.MedianFilter(size=10))
obraz_min = obraz.filter(ImageFilter.MinFilter(size=10))
obraz_max = obraz.filter(ImageFilter.MaxFilter(size=10))
